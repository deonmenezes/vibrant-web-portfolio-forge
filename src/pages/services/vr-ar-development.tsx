                        ...
                        {packages.map((pkg, index) => (
                            ...
                            >
                                ...
                                <div className={`relative border-4 border-black p-8 h-full ${pkg.highlighted ? 'bg-black' : 'bg-white'}`}>
                                    ...
                                    <CheckoutButton
                                        service="vr-ar-development"
                                        packageName={pkg.name}
                                        fallbackHref="https://wa.me/918104796542?text=Hi%20Virelity!%20I'm%20interested%20in%20the%20VR/AR%20Development%20package.%20Can%20we%20discuss?"
