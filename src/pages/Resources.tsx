      ...
      <div className="min-h-screen bg-gradient-to-b from-background to-secondary/30 text-foreground">
        ...
        <main className="pt-28 pb-20">
          <section className="container mx-auto px-4 mb-16">
            <Link to="/resources/security-resources" className="group flex flex-col justify-between gap-8 rounded-2xl border border-emerald-400/40 bg-gradient-to-br from-[#07130f] to-[#0d211a] p-6 text-white shadow-xl transition-transform hover:-translate-y-1 md:flex-row md:items-center md:p-10"><div className="max-w-3xl"><span className="mb-4 inline-flex items-center gap-2 text-xs font-black uppercase tracking-[0.18em] text-emerald-400"><Sparkles className="h-4 w-4" /> New security field guide</span><h2 className="text-3xl font-black leading-tight md:text-5xl">AI security harnesses & bug bounty resources</h2><p className="mt-4 text-base text-white/65 md:text-lg">Strix, MantisHack, Shannon, CAI, PentestGPT, Raptor, agent-security scanners, hands-on labs, and responsible disclosure guidance.</p></div><span className="inline-flex shrink-0 items-center gap-2 rounded-xl bg-emerald-400 px-5 py-3 font-black text-black transition-transform group-hover:translate-x-1">Open field guide <ArrowRight className="h-5 w-5" /></span></Link>
          </section>
