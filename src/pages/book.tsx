                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            >
                                ...
                                <svg className="w-24 h-8" viewBox="0 0 200 60" fill="currentColor">
                                    <path d="M71.4 37.6c-9.2 6.8-22.5 10.4-34 10.4-16.1 0-30.6-6-41.6-15.9-.9-.8-.1-1.8.9-1.2 11.8 7 26.4 11.2 41.6 11.2 10.2 0 21.4-2.1 31.7-6.5 1.6-.7 2.9 1 1.4 2.1z"/>
                                    <path d="M75 33.6c-1.2-1.5-7.8-.7-10.8-.4-.9.1-1-.7-.2-1.2 5.3-3.7 13.9-2.6 14.9-1.4 1 1.2-.3 9.9-5.2 14-.7.6-1.5.3-1.1-.5 1.1-2.7 3.6-9 2.4-10.5zM67.4 12.3V10c0-.6.4-1 1-1h17c.5 0 1 .4 1 1v2c0 .6-.5 1.3-1.3 2.4l-8.8 12.6c3.3-.1 6.7.4 9.7 2.1.7.4.8.9.9 1.5v2.2c0 .6-.6 1.2-1.3.9-5.2-2.8-12.2-3.1-18 0-.6.3-1.2-.3-1.2-.9v-2.1c0-.6 0-1.7.6-2.6l10.2-14.6h-8.8c-.6 0-1-.4-1-1zM25.3 35.9h-5.2c-.5 0-.9-.4-.9-.9V9.9c0-.5.4-1 1-1h4.8c.5 0 .9.4.9.9v3.3h.1c1.3-3.3 3.6-4.8 6.8-4.8 3.2 0 5.3 1.5 6.7 4.8 1.3-3.3 4.1-4.8 7.2-4.8 2.2 0 4.6.8 6 2.8 1.6 2.1 1.3 5.2 1.3 7.9v15.7c0 .5-.4 1-1 1h-5.2c-.5 0-.9-.4-.9-1V20.8c0-1.1.1-3.9-.1-5-.4-1.8-1.5-2.3-3-2.3-1.3 0-2.6.8-3.1 2.2-.5 1.3-.5 3.5-.5 5.1v13.1c0 .5-.4 1-1 1h-5.2c-.5 0-.9-.4-.9-1V20.8c0-3 .5-7.4-3.2-7.4-3.7 0-3.6 4.3-3.6 7.4v13.1c0 .5-.4 1-1 1zM95.5 7.9c7.7 0 11.8 6.6 11.8 15 0 8.1-4.6 14.6-11.8 14.6-7.5 0-11.6-6.6-11.6-14.8 0-8.3 4.2-14.7 11.6-14.7zm0 5.4c-3.8 0-4.1 5.2-4.1 8.5 0 3.3 0 10.2 4 10.2 4 0 4.2-5.6 4.2-9 0-2.3-.1-4.9-.8-7.1-.6-1.9-1.7-2.8-3.4-2.8zM120.4 35.9h-5.1c-.5 0-.9-.4-.9-1V9.9c0-.5.5-.9 1-.9h4.8c.5 0 .8.3.9.7v3.9h.1c1.4-3.5 3.5-5.2 7.1-5.2 2.3 0 4.6.8 6 3.1 1.4 2.1 1.4 5.8 1.4 8.4v15.4c0 .5-.4.9-1 .9h-5.2c-.5 0-.9-.4-.9-.8V20.1c0-2.9.3-7.2-3.2-7.2-1.3 0-2.4.8-3 2.1-.7 1.6-.8 3.2-.8 5.1v13.2c0 .5-.4 1-1 1z"/>
                                    <path d="M8.7 50.8c-3.1-.2-5.8-1.7-6.9-4.3-.2-.4 0-.5.3-.4l3.2.5c.3 0 .5.2.6.5.5 1.3 1.6 1.9 2.9 1.9 1.7 0 3-.8 3-2.5v-1.4c-1 .7-2.3 1.2-3.7 1.2-3.3 0-5.3-2-5.3-5.2 0-3.3 2.1-5.4 5.3-5.4 1.9 0 3.1.6 4 1.8v-.9c0-.3.2-.5.5-.5h2.5c.3 0 .5.2.5.5v10.5c0 2.2-1.2 3.5-3 4.1-.9.3-2 .4-3.1.3zm3-8.3v-1.2c0-1.7-1.1-2.9-2.7-2.9-1.4 0-2.4 1-2.4 2.5s.9 2.5 2.4 2.5c1.6 0 2.7-1.2 2.7-2.9zm13.7 4.4c0 .3-.2.5-.5.5h-2.6c-.3 0-.5-.2-.5-.5V36.7c0-.3.2-.5.5-.5h2.6c.3 0 .5.2.5.5v10.2zm2.4 0c0-.3.2-.5.5-.5h2.6c.3 0 .5.2.5.5v10.2c0 .3-.2.5-.5.5h-2.6c-.3 0-.5-.2-.5-.5V46.9z"/>
                                </svg>
                            ...
                            >
                                ...
                                <div className="relative z-10 flex flex-col items-center gap-3">
                                    {/* Flipkart Logo */}
                                    <svg className="w-24 h-8 opacity-50" viewBox="0 0 200 60" fill="currentColor">
                                        <path d="M15 4C8.4 4 3 9.4 3 16s5.4 12 12 12 12-5.4 12-12S21.6 4 15 4zm0 21c-5 0-9-4-9-9s4-9 9-9 9 4 9 9-4 9-9 9z"/>
                                        <path d="M45 12h-7v3h7v3h-7v5h-3V9h10v3zm7 10h-3V9h3v13zm4-6v6h-3V9h3v5c.4-.3.9-.6 1.5-.8.6-.2 1.2-.3 1.8-.3 1.3 0 2.3.4 3 1.2.7.8 1.1 1.9 1.1 3.3v4h-3v-3.8c0-.8-.2-1.3-.5-1.7-.3-.3-.8-.6-1.4-.6-.4 0-.8.1-1.2.3-.4.2-.7.4-.9.8zm19 2.4c0 .3 0 .6-.1.8h-7.6c.1.7.3 1.2.8 1.5.4.3.9.5 1.6.5.5 0 .9-.1 1.3-.3.3-.2.6-.5.8-.9h2.7c-.3.9-.8 1.7-1.5 2.3-.8.6-1.7.8-3 .8-.9 0-1.8-.2-2.5-.6-.7-.4-1.3-.9-1.7-1.7-.4-.8-.6-1.6-.6-2.5s.2-1.8.6-2.5c.4-.8 1-1.3 1.7-1.7.7-.4 1.6-.6 2.5-.6s1.8.2 2.5.6c.7.4 1.3.9 1.6 1.6.4.7.6 1.5.6 2.4v.3zm-2.7-.7c0-.6-.2-1.1-.6-1.5-.3-.3-.8-.5-1.4-.5-.5 0-1 .2-1.4.5-.3.3-.6.9-.7 1.5h4.1z"/>
                                        <path d="M90 18h4l4 8 4-8h4v18h-4v-9l-3 6h-2l-3-6v9h-4V18zm23 14c-.8-.8-1.2-2-1.2-3.5v-5.4h-2V18h2v-3h4v3h3v5.1h-3v5c0 .4.1.7.3.9.2.2.5.3.9.3h2v4h-3c-1.5 0-2.7-.4-3.5-1.3z"/>
                                    </svg>
